...
/**
 * Basic class representing an object of any type in R. Each type in R in
 * represented by a specific subclass.
 * <p>
 * This class defines basic accessor methods (<tt>as</tt><i>XXX</i>), type check
 * methods (<tt>is</tt><i>XXX</i>), gives access to attributes
 * ({@link #getAttribute}, {@link #hasAttribute}) as well as several convenience
 * methods. If a given method is not applicable to a particular type, it will
 * throw the {@link REXPMismatchException} exception.
 * <p>
...
public class REXP implements java.io.Serializable {
   ...
   *
   * @return <code>true</code> if the receiver is a character vector,
   ...
   *
   * @return <code>true</code> if the receiver is a numeric vector,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is an integer vector,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is NULL, <code>false</code>
   * otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a factor, <code>false</code>
   * otherwise
   */
  ...
  /**
   * check whether the <code>REXP</code> object is a list (either generic vector
   * or a pairlist - i.e. {@link #asList()} will succeed)
   *
   * @return <code>true</code> if the receiver is a generic vector or a
   * pair-list, <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a pair-list,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a logical vector,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is an environment,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a language object,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is an expression vector,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a symbol, <code>false</code>
   * otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a vector, <code>false</code>
   * otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a raw vector,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a complex vector,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a recursive object,
   * <code>false</code> otherwise
   */
   ...
   *
   * @return <code>true</code> if the receiver is a reference,
   * <code>false</code> otherwise
   */
  ...
  /**
   * returns the contents as an array of Strings (if supported by the
   * represented object)
   */
  ...
  /**
   * returns the contents as an array of integers (if supported by the
   * represented object)
   */
  ...
  /**
   * returns the contents as an array of doubles (if supported by the
   * represented object)
   */
  ...
  /**
   * returns the contents as an array of bytes (if supported by the represented
   * object)
   */
  ...
  /**
   * returns the contents as a (named) list (if supported by the represented
   * object)
   */
  ...
  /**
   * attempt to represent the REXP by a native Java object and return it. Note
   * that this may lead to loss of information (e.g., factors may be returned as
   * a string array) and attributes are ignored. Not all R types can be
   * converted to native Java objects. Also note that R has no concept of
   * scalars, so vectors of length 1 will always be returned as an arrays (i.e.,
   * <code>int[1]</code> and not <code>Integer</code>).
   */
  ...
  /**
   * returns the length of a vector object. Note that we use R semantics here,
   * i.e. a matrix will have a length of <i>m * n</i> since it is represented by
   * a single vector (see {@link #dim} for retrieving matrix and
   * multidimentional-array dimensions).
   *
   ...
   * <code>true</code> for NA values and <code>false</code> for any other values
   *
   * @return a boolean vector of the same length as this vector with
   * <code>true</code> for NA values and <code>false</code> for any other values
   * @throws REXPMismatchException if this is not a vector object
   */
   ...
   * @return attribute value or <code>null</code> if the attribute does not
   * exist
   */
  ...
  /**
   * returns dimensions of the object (as determined by the "<code>dim</code>"
   * attribute)
   *
   * @return an array of integers with corresponding dimensions or
   * <code>null</code> if the object has no dimension attribute
   */
  public int[] dim() {
    try {
  ...
  /**
   * determines whether this object inherits from a given class in the same
   * fashion as the <code>inherits()</code> function in R does (i.e. ignoring S4
   * inheritance)
   *
   * @param klass class name
   * @return <code>true</code> if this object is of the class
   * <code>klass</code>, <code>false</code> otherwise
   */
   ...
   * <b>{@link #getAttribute} should be used instead to access specific
   * attributes</b>!. Note that the {@link #attr} attribute should never be used
   * directly incase the REXP implements a lazy access (e.g. via a reference)
   *
   * @return list of attributes or <code>null</code> if the object has no
   * attributes
   */
   ...
   *
   * @return string describing the object - it can be of an arbitrary form and
   * used only for debugging (do not confuse with {@link #asString()} for
   * accessing string REXPs)
   */
  ...
  /**
   * returns representation that it useful for debugging (e.g. it includes
   * attributes and may include vector values -- see {@link #maxDebugItems})
   *
   ...
   * m[rows][cols]). This is the same form as used by popular math packages for
   * Java, such as JAMA. This means that following leads to desired results:<br>
  ...
  /**
   * creates a REXP that represents a double matrix in R based on matrix of
   * doubles (2D-array: m[rows][cols]). This is the same form as used by popular
   * math packages for Java, such as JAMA. The result of this function can be
   * used in {@link REngine.assign} to store a matrix in R.
   *
   * @param matrix array <code>double[rows][colums]</code> containing the matrix
   * to convert into a REXP. If <code>matrix</code> is <code>null</code> or
   * either of the dimensions is 0 then the resulting matrix will have the
   * dimensions <code>0 x 0</code> (Note: Java cannot represent
   * <code>0 x n</code> matrices for <code>n &gt; 0</code>, so special matrices
   * with one dimension of 0 can only be created by setting dimensions
   * directly).
   * @return <code>REXPDouble</code> with "dim" attribute which constitutes a
   * matrix in R
   */
   ...
   *
   * @param l a (named) list of vectors ({@link REXPVector} subclasses), each
   * element corresponds to a column and all elements must have the same length
   * @return a data frame object
   * @throws REXPMismatchException if the list is empty or any of the elements
   * is not a vector
   */
  ...
  /**
   * specifies how many items of a vector or list will be displayed in
   * {@link #toDebugString}
   */
